...
<!--
					<div class="row form-group">
						<div class="col-sm col-xs-12 col-spacing{{ $errors->has('phone') ? ' has-error' : '' }}">
				            <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone') }}" required placeholder="Phone">
				            @if ($errors->has('phone'))
				                <span class="help-block">
...
-->
			...
			<div class="card">
				<div class="card-header">Reference or Invoice Number</div>
	
	            <div class="card-body">
			        <div class="row">
						<div class="col-sm">
							<div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
					            <input id="reference" type="text" class="form-control" name="reference" value="{{ old('reference') }}" required placeholder="Reference or Invoice No.">
